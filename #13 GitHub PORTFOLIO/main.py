...
# Repositorga ma'nili nom beramiz. Nom berishda kichik harflar bilan yozing va bo'sh joy o'rniga chiziqcha (-) ishlating.
# Repository ommaga ochiq (public)yoki yopiq (private) bo'lishini tanlaymiz. Buni keyin ham o'zgartirish mumkin.
# README faylini qo'shish (qo'shmalikni) tanlaymiz. README faylida siz loyiha haqida batafsil ma'lumot berishingiz mumkin. Agar loyiha omma uchun bo'lsa albatta README faylini ham tanlang va loyihangiz haqida ma'lumot bering.
# Create Repository tugmasini bosamiz.
...
# AMALIYOT
# GitHub.com sahifasidan ro'yxatdan o'ting
# Kompyuteringizga GitHub Desktop dasturini o'rnating
# GitHubda Python darslari uchun yangi repository yarating
# Shu vaqtgacha yozgan kodlaringizni yangi repositoryga yuklang
# Sahifamizga qo'yib borilayotgan mashg'ulotlarning javoblarini quyidagi repositorydan o'zingizga Clone qilib oling:
